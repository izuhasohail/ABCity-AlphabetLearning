...
export function BoxBg() {
  return (
    <div className="text-white h-screen relative w-full overflow-hidden  bg-navy flex flex-col items-center justify-start pt-32 rounded-lg">
      ...
      {/* Chat GPT Code */}
      <div className="flex flex-col sm:flex-row mt-24 w-3/4 sm:w-1/2 lg:w-1/4 mx-auto justify-between items-center bg-gradient-to-r from-purple-400 to-purple-700 z-20 px-4 py-2 pl-3 rounded-full">
